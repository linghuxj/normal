...
import { getMenuRoleTreeOptionsApi } from '@/api/admin/auth/menu'
import { getDeptUserTreeOptionsApi } from '@/api/admin/auth/dept'
import { eachTree } from '@/utils/tree'
import { isEmptyVal } from '@/utils/is'
import { putRoleListApi } from '@/api/admin/auth/role'
...
const getOptions = async () => {
  ...
  const dictOptions = await dictStore.getDictObj(['sys_admin_data_range'])
  dataRangeOptions.value = dictOptions.sys_admin_data_range
}
